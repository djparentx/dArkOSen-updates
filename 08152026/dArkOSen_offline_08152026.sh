...
if [ ! -f "/home/ark/.config/.dArkOSen-update08152026" ]; then
	...
	sleep 2
	if [ -f "/opt/system/Tools/dArkOSen-update08152026.zip" ]; then	
		# unzip
		unzip -X -o /opt/system/Tools/dArkOSen-update08152026.zip -d / | tee -a "$LOG_FILE"
		sleep 1
		# run update script
		...
		rm -fv /opt/system/Tools/dArkOSen-update08152026.zip | tee -a "$LOG_FILE"
		sleep 3
